...
scomplex_f FC_FUNC(cdotu,CDOTU)  (const integer* n,                        const scomplex* x, const integer* incx, const scomplex* y, const integer* incy);
scomplex_f FC_FUNC(cdotc,CDOTC)  (const integer* n,                        const scomplex* x, const integer* incx, const scomplex* y, const integer* incy);
...
dcomplex_f FC_FUNC(zdotu,ZDOTU)  (const integer* n,                        const dcomplex* x, const integer* incx, const dcomplex* y, const integer* incy);
dcomplex_f FC_FUNC(zdotc,ZDOTC)  (const integer* n,                        const dcomplex* x, const integer* incx, const dcomplex* y, const integer* incy);
...
{
    scomplex_f tmp = FC_FUNC(cdotu,CDOTU)(&n, x, &incx, y, &incy);
...
static inline scomplex c_cdotc (const integer n, const scomplex* x, const integer incx,
                                                 const scomplex* y, const integer incy)
{
    scomplex_f tmp = FC_FUNC(cdotc,CDOTC)(&n, x, &incx, y, &incy);
    return MAKE_COMPLEX(float, tmp.real, tmp.imag);
}
...
{
    dcomplex_f tmp = FC_FUNC(zdotu,ZDOTU)(&n, x, &incx, y, &incy);
...
static inline dcomplex c_zdotc (const integer n, const dcomplex* x, const integer incx,
                                                 const dcomplex* y, const integer incy)
{
    dcomplex_f tmp = FC_FUNC(zdotc,ZDOTC)(&n, x, &incx, y, &incy);
    return MAKE_COMPLEX(double, tmp.real, tmp.imag);
}
